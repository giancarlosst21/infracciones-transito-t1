...
public class MultaServiceImpl implements IMultaService {
    ...
    public void actualizarEstados() {
        List<Multa> multas = multaRepository.findMultasPendientes();
    ...
    @Override
    public List<Multa> obtenerMultasPorPlaca(String placa) {
        return multaRepository.findByVehiculo_Placa(placa);
    }
}